...
class _HouseholdDetailScreenState extends State<HouseholdDetailScreen> {
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Documents Section
                if (household.documentUrls.isNotEmpty) ...[
                  _buildInfoSection(
                    context,
                    'Giấy tờ hộ gia đình',
                    ...
                    [
                      SizedBox(
                        ...
                        child: ListView.separated(
                          ...
                          itemCount: household.documentUrls.length,
                          separatorBuilder: (_, __) =>
                              const SizedBox(width: 10),
                          itemBuilder: (context, index) {
                            final url = household.documentUrls[index];
                            return ClipRRect(
                              borderRadius: BorderRadius.circular(10),
                              child: GestureDetector(
                                onTap: () =>
                                    _showDocumentPreview(context, url, index),
                                child: Image.network(
                                  url,
                                  width: 100,
                                  height: 100,
  ...
  void _showDocumentPreview(BuildContext context, String url, int index) {
    showDialog(
      context: context,
      builder: (ctx) => Dialog(
